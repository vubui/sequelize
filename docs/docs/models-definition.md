...
The BLOB data type allows you to insert data both as strings and as buffers. When you do a find or findAll on a model which has a BLOB colum, that data will always be returned as a buffer.
